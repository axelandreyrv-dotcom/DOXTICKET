...
## Navegacion
- Top nav simple: Dashboard, Tickets, Actividad, Base de conocimiento, Configuracion.
...
La navegacion publica actual muestra solo `Login` en `/`; las pantallas de login/setup no muestran botones duplicados en el encabezado. La navegacion autenticada incluye Dashboard, Tickets, Actividad, Empresa y Configuracion. Base de conocimiento se agregara cuando exista el modulo.
