...
- `tests/Feature/Admin/AdminDashboardTest.php` cubre acceso superadmin, health, updates cacheados, chequeo manual protegido de actualizaciones y logo/favicons de marca.
