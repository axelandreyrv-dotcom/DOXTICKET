...
- Listado `/admin/users` para revisar usuarios globales, superadmins y membresias por empresa, con activacion/desactivacion global protegida, edicion de rol/estado de membership, registro de invitaciones a empresa con correo SMTP global, enlace de definicion de contrasena para usuarios nuevos y bloqueo para no desactivar la propia cuenta superadmin ni dejar una empresa sin admin activo.
